  ...
  public class TestUnitOfWork
  {
    ...
    public void TestRegister()
    {
      using(DummyRepositoryConnection connection = new DummyRepositoryConnection())
      {
        ...
        Assert.AreEqual("Create entity '[CraigFowler.Patterns.DDD.Mocks.Entities.Person: no identity]'\n",
    ...
    public void TestPerformWork()
    {
      using(DummyRepositoryConnection connection = new DummyRepositoryConnection())
      {
        ...
        Assert.AreEqual("Create entity '[CraigFowler.Patterns.DDD.Mocks.Entities.Person: no identity]'\n" +
                        "Update entity '[CraigFowler.Patterns.DDD.Mocks.Entities.Person: 5]'\n",
                        connection.Log.ToString(),
                        "Correct log message");
      }
    }
