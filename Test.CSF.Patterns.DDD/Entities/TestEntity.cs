...
namespace Test.CSF.Patterns.DDD.Entities
{
  [TestFixture]
  public class TestEntity
  {
    ...
    public void TestToString()
    {
      ...
      Assert.AreEqual("[CSF.Patterns.DDD.Mocks.Entities.Person: 5]", entity.ToString(), "Correct identity");
      
      entity.ClearIdentity();
      Assert.AreEqual("[CSF.Patterns.DDD.Mocks.Entities.Person: no identity]",
                      entity.ToString(),
                      "Cleared identity");
    }
